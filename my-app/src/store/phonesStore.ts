...
class PhonesStore {
    phones: PhoneType[] = [
        ...
        { id: 3, name: "Samsung Galaxy A72", imageName: "Samsung_Galaxy_A72", manufacturer: "Samsung", year: "2021", diagonal: "6,7", country: "Вьетнам", memory: "128 Гб", frequency: "90 Гц", nfc: true, eSIM: false, charging: true, price: "32 890 ₽" },
